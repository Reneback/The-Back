...
<br><input type="submit" name="submit" value="Se connecter">
      ...
      <li class="nav-item active">
        <a class="nav-link " href="#" data-toggle="modal" data-target="#exampleModalCenter">S'inscrire</a>
      </li>
...
<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form  class="form-group" id="newuser" action="./static/controllers/newuser.php" method="post" enctype="multipart/form-data">
